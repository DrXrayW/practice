...
public class BinaryTreePostorderTraversal_Morris02 {
	
	public static void main(String[] args) {
		BinaryTreePostorderTraversal_Morris02 s = new BinaryTreePostorderTraversal_Morris02();
	...
	// no need to know to, we are reversing the whole .right chain, till null
	// as tail.right will be the last node.right, it will be set to null after reverse
	//so this is working both ways
    public void reverse(TreeNode from){
